...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex h-10 w-full items-center justify-between rounded-lg border border-input bg-card px-3.5 py-2 text-sm transition-[border-color,box-shadow] placeholder:text-muted-foreground focus:border-primary/55 focus:outline-none focus:ring-2 focus:ring-ring/25 disabled:cursor-not-allowed disabled:opacity-50 [&>span]:line-clamp-1",
      className
    )}
    {...props}
  >
    ...
    <SelectPrimitive.Icon asChild>
      <Icon icon={altArrowDownLinear} className="h-4 w-4 opacity-50" />
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.ScrollUpButton
    ...
    {...props}
  >
    <Icon icon={altArrowUpLinear} className="h-4 w-4" />
  </SelectPrimitive.ScrollUpButton>
))
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.ScrollDownButton
    ...
    {...props}
  >
    <Icon icon={altArrowDownLinear} className="h-4 w-4" />
  </SelectPrimitive.ScrollDownButton>
))
  ...
  >
    <span className="absolute left-2 flex h-3.5 w-3.5 items-center justify-center">
      <SelectPrimitive.ItemIndicator>
        <Icon icon={checkReadLinear} className="h-4 w-4" />
      </SelectPrimitive.ItemIndicator>
    </span>
